...
class Query extends \Google\Protobuf\Internal\Message
{
     ...
     * </pre>
     *
     * <code>.protos.List uid_list = 5;</code>
     */
     ...
     * </pre>
     *
     * <code>repeated string src_func = 6;</code>
     */
    private $src_func;
    /**
     * <pre>
    ...
    {
        GPBUtil::checkMessage($var, \Protos\Lists::class);
        $this->uid_list = $var;
    ...
    {
        GPBUtil::checkMessage($var, \Protos\Param::class);
    ...
    {
        GPBUtil::checkMessage($var, \Protos\FilterTree::class);
